...
9. **ADDED: WHY DIDN'T IT WORK?** Every now and then I get this one, and, well, ¯\\_ (ツ)_/¯. If you're on the list (again, [here](https://bsky.app/profile/did:plc:6brknehpd7ecbvd56ko6mhlm/lists/3jzmymatqtf2u)) and you used the emoji, it should work! All I can plead is that it's a beta site, I guess; sorry. I have noticed it does take a little time, sometime, especially on busy days. It is **possible** that it's something to do with spacing around the emoji, i.e., that you need to have a space before and/or after, but I'm not sure.
