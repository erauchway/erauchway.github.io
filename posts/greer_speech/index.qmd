...
> In a fireside chat delivered on September 11, FDR deliberately distorted the details of the incident. He claimed that the *Greer's* identity as a U.S. ship was unmistakable and that the German submarine fired first without warning. He went on to outline a Nazi design to abolish the freedom of the seas as a prelude to domination of the United States.[@schuesslerDeceptionDividendFDR2010a, 157]
...
> His original view has undergone no changes whatsoever. He would, however, like to avoid having the U.S.A. declare war while the Eastern Campaign is still in progress, also out of consideration for the Army which is involved in heavy combat. But he will never call a submarine commander to account if he torpedoes an American ship by mistake.[@FuehrerConferencesNaval1990a, 222]
